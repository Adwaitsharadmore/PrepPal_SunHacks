...
export default function Home() {
  const features = [
    {
      title: "Convert Notes to Cheatsheets",
      description:
        "Upload your course PDFs, and PrepPal will generate concise, focused cheatsheets to help you study efficiently.",
      imgSrc: "/path-to-cheatsheet-image.jpg", // replace with actual image path
    },
    {
      title: "Tailored Study Resources",
      description:
        "PrepPal analyzes your notes and highlights key concepts, making it easier to focus on what's important for your exams.",
      imgSrc: "/path-to-study-resources-image.jpg", // replace with actual image path
    },
    {
      title: "Instant PDF Uploads",
      description:
        "Easily upload your course material and get instant access to cheatsheets, saving you time and effort in exam preparation.",
      imgSrc: "/path-to-pdf-upload-image.jpg", // replace with actual image path
    },
  ];
